...
public class product extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvproduct = findViewById(R.id.rvproductdisplay);
    ...
    private void getProduct() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, WebUrl.PRODUCT_DISPLAY_URL, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                p.put(JsonField.PRODUCT_CATEGORY_ID,cid);
                return p;
            }
        };
        ...
        try {
            ...
            if(flag == 1)
            {
                ...
                if(jsonArray.length() > 0)
                {
                    ...
                    productAdapter = new productAdapter(product.this,listProduct);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        itemcart.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent toCart = new Intent(product.this,My_cart.class);
